  ...
  return (
    <div className="container py-md-5 mt-md-3">
      <div className="row mb-4">
        {animals.length > 0 ? (
          animals.map(({id, animalType, adoptable, image }, index) => (
            <div className="col-md-3" key={index}>
              <div className="card">
                <img src={image || "Dog.jpg"} className="card-img-top" alt="Animal" />
                <div className="card-body">
                  <h5 className="card-title text-center">Animal Details</h5>
                  <h6 className="card-title text-center">Price: {price[animalType]}</h6>
                  ...
                  <div className="d-grid mx-auto">
                    ...
                    <AnimalAdoption animalId={id} price={price[animalType]}/>
