...
const Signup = () => {
  ...
  return (
    <>
      <body>
        <div className="user-container" style={{ "backgroundImage": "url(bg3.jpg)" }}>
          ...
          >
            <form>
              ...
              <div className='form-group'>
                ...
                <input type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} className="form-control" id="exampleInputPassword1" placeholder=" conform Password" />
              </div>
              <div className="form-group">
                <label htmlFor="exampleInputPassword1">Profile Picture</label>
                <input type="file" onChange={e => handleFileChange(e)} className="form-control" id="exampleInputPassword1" placeholder="Upload File" />
              </div>
