...
const FosterCarePage = () => {
  ...
  return (
    ...
    //      <button className="btn btn-primary btn-sm w-25" >
    //        Add 
    //      </button>
    //    </div> */}
            ...
            <div className="card mb-4">
              <div className="card-body">
                ...
                <p className="card-text">
                  <strong>Phone Number:</strong> {fosterCare.phoneNumber}
                </p>
                <p className="card-text">
                  <strong>Location:</strong> {fosterCare.location}
                </p>
                <p className="card-text">
                  <strong>City:</strong> {fosterCare.city}
                </p>
                <p className="card-text">
                  <strong>State:</strong> {fosterCare.state}
                </p>
              </div>
              <button
                className="btn btn-primary"
                onClick={() => viewDetails(fosterCare)}
              >
                view details
              </button>
